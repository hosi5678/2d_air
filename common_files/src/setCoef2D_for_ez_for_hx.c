...
const double **setCoef2D_for_ez_for_hx(
   const double **eps,
   const double **sigma,
   int y_length,
   int x_length){

   double **coef_plane=init2DdoublePlane("in ez coef 2d hx",y_length,x_length);
   double dt=get_dt();
   ...
   set2DDoubleCSV((const double * const *)coef_plane,"coef2d_for_ez_hx",y_length,x_length);
